...
AGLClass::AGLClass() : mLat(0), mLon(0)
{
}
...
double AGLClass::getGroundLevel(File * file, double lat, double lon)
{
...
int AGLClass::openFile(const char * name)
{
	if (mFile)
		return -1;

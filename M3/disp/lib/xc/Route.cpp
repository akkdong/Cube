...
{
	const auto &taskType = doc["taskType"];
	const auto &turnPoints = doc["turnpoints"];
	const auto &sss = doc["sss"];
	const auto &goal = doc["goal"];
	const auto &model = doc["earthModel"];
